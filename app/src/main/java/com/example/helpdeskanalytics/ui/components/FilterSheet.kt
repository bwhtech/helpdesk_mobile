...
import com.example.helpdeskanalytics.domain.model.filter.FilterFieldType
import com.example.helpdeskanalytics.domain.model.filter.FilterOperator
import com.example.helpdeskanalytics.domain.model.filter.FilterableField
import com.example.helpdeskanalytics.domain.model.filter.IS_NOT_SET
import com.example.helpdeskanalytics.domain.model.filter.IS_SET
import com.example.helpdeskanalytics.domain.model.filter.Timespan
import com.example.helpdeskanalytics.domain.model.filter.defaultValueFor
